        ...
        <div className="container mx-auto max-w-4xl">
          <section className="py-16">
            ...
            <p className="text-lg leading-relaxed mb-8" style={{ color: '#666666' }}>
              Witaj w sekcji „Szkatułka Kosztowności" – miejscu, gdzie przechowujemy najcenniejsze skarby i odkrycia.
            </p>
            <p className="text-base leading-relaxed" style={{ color: '#666666' }}>
              Każdy element w tej kolekcji został starannie wybrany i ma swoją unikalną historię do opowiedzenia.
            </p>
          </section>
        </div>
      </main>
